...
class Dispatcher {
	...
	public void allowLanding(Airplane a){
		...
		//TODO: ƒописать метод, разрешающий посадку (создание новых, переиспользование старых)
	...
	public void allowTakeoff(Airplane a){
		...
		//TODO: ƒописать метод, разрешающий взлет (создание новых, переиспользование старых)
